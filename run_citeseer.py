...
from model import LLGC, PageRankAgg, sgc_precompute
...
parser.add_argument('--weight_decay', type=float, default=9.8e-05,
...
parser.add_argument('--K', type=int, default=20, help='number of propagation steps.')
...
def main(args):
    ...
    model, train_time = train(model, x_gconv[idx_train], labels[idx_train], idx_train, args.epochs, args.weight_decay, args.lr)
