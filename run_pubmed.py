...
parser.add_argument('--dataset', type=str, default="pubmed",
                    help='Dataset to use.')
parser.add_argument('--lr', type=float, default=0.94,
                    help='Initial learning rate.')
parser.add_argument('--weight_decay', type=float, default=8.8e-06,
...
parser.add_argument('--bias', type=int, default=0, help='Use bias or not.')

parser.add_argument('--K', type=int, default=23, help='number of propagation steps.')
